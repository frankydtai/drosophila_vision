...
Left vs right eye: only the sti direction for A→P vs P→A is mirrored (`right` ↔ `left`); up/down unchanged.
...
**DSI is always: this cell’s sti direction minus the opposite direction.**
