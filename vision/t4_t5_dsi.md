...
Experimental reference traces come from **[`figure_digitization/gruntman2021/1ci_digitized.csv`](../../figure_digitization/gruntman2021/1ci_digitized.csv)** — digitized population Vm from Gruntman et al. (2021) Figure 1 panels **Ci** (T4) and **Cii** (T5). Produced by [`figure_digitization/gruntman2021/1ci.py`](../../figure_digitization/gruntman2021/1ci.py) from a rendered figure PNG (approximate raster values, not raw lab data).
...
The CSV holds **16 traces** per pathway panel: 2 contrasts × 2 widths × 2 directions. Subtype-specific tables below map each `(eye, stimulus)` to one of those keys via `t4_t5_dsi.py` (`fig1_key_for_stimulus` → `T4_PC_w1_PD` style ids). Training loads the same data as [`1ci_digitized.npz`](../../figure_digitization/gruntman2021/1ci_digitized.npz) (`FIG1_CI_NPZ` in `task.moving_bar.gt`).
...
Population traces in [`1ci_digitized.csv`](../../figure_digitization/gruntman2021/1ci_digitized.csv)
...
- **Data:** [`figure_digitization/gruntman2021/1ci_digitized.csv`](../../figure_digitization/gruntman2021/1ci_digitized.csv) — Figure 1 Ci/Cii traces (Gruntman et al. 2021), digitized by `gruntman2021/1ci.py`.
