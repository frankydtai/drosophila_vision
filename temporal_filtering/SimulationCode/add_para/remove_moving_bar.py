...
import train
from t4_t5_preference import READOUT_SUBTYPE_ALIASES, READOUT_SUBTYPES, expand_readout_subtypes
...
try:
    removed = frozenset(expand_readout_subtypes(train.parse_comma_list(args.remove_subtypes)))
