...
builders wrap the neutral target dataclasses from ``stimulus`` (which sit below
...
from training.cost import _build_cost_subpacks, _build_fused_conductance
...
from stimulus.moving_bar.input import resolve_i_baseline
...
def _network_backend_from_connectome(C, *, sim_dtype=SIM_DTYPE_DEFAULT) -> ModelBackend:
    ...
    from stimulus.constants import LEAK_DEPOL_TYPES
