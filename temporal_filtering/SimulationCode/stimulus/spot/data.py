...
- ``pulse_ms`` (#1): the PR drive comes from
  :func:`stimulus.spot.input.spot_input_waveform`, shared by the network signal
  and the ImpR target.
...
from neuron_model.constants import deltat
...
from stimulus.constants import cell_list as _CELL_LIST
...
def read_RecF_ImpR(*, t_on=None, maxtime=None, pulse_ms=None):
    ...
    drive is :func:`stimulus.spot.input.spot_input_waveform` (step or pulse).
    """
