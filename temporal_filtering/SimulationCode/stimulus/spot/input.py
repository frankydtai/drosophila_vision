...
the ImpR target in :mod:`stimulus.spot.data`, so pulse duration has a single
source.
"""
...
from config import DELTAT_MS, ms_to_steps
...
def spot_extent_folds_r2_into_r1(spot_extent) -> bool:
    ...
    Fold semantics live in :mod:`stimulus.spot.data`: r=1 target amplitude is
